...
RIGHT_MOTOR_CORRECTION_FACTOR = 0.9680000   # Calibração 20/03/2026 — histórico:
                                            #   R=0.96  → desvio direita (12-31 correções scan matching)
                                            #   R=0.97  → desvio esquerda (3 correções)
