...
class RobotMotorController(QObject):
    ...
    def __init__(self):
        ...
        self.pid_left = PIDController(Kp=0.11, Ki=0.05, Kd=0.0, setpoint=0, output_limits=(-50, 50))
        self.pid_right = PIDController(Kp=0.11, Ki=0.05, Kd=0.0, setpoint=0, output_limits=(-50, 50))
